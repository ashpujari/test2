...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public static final String QUESTIONS_COLUMN_QUESTION_NO = "question_no";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "create table " + QUESTIONS_TABLE_NAME + " (" +
                        ...
                        QUESTIONS_COLUMN_QUESTION_NO + " text, " +
    ...
    public boolean insertQuestion(String question_no, String question, String answer) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(QUESTIONS_COLUMN_QUESTION_NO, question_no);
    ...
    public boolean updateQuestion(Integer id, String question_no , String question, String answer) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(QUESTIONS_COLUMN_QUESTION_NO, question_no);
        contentValues.put(QUESTIONS_COLUMN_QUESTION, question);
        contentValues.put(QUESTIONS_COLUMN_ANSWER, answer);
        db.update(QUESTIONS_TABLE_NAME, contentValues, QUESTIONS_COLUMN_QUESTION_NO + " = ? ", new String[]{Integer.toString(id)});
    ...
    public List<Question> getAllQuestions() {
        ...
        while (res.isAfterLast() == false) {
            ...
            q.setQuestionNo(res.getString(res.getColumnIndex(QUESTIONS_COLUMN_QUESTION_NO)));
